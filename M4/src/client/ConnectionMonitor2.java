...
public class ConnectionMonitor2 extends Thread{
    ...
    public ConnectionMonitor2(KVStore client_in, KVSubscription sub_client_in, String clientName) {
		...
		try {
			...
			while(!stop) {
			    ...
			    try {
                         ...
                         System.out.println("Normal Client disconnection detected");
                         Thread.sleep(10 * 1000);
                         logger.debug("Normal Client Start reconnecting***");
                         client.reconnect();
				}
